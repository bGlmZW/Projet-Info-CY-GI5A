...
public class ToolBox extends HBox {
	...
	// Buttons in the toolbox at the top of the interface
    ...
    /**
     * Applies the same visual behavior to every control button.
     *
     * @param btn button to configure
     * @param text text displayed on the button
     * @param base normal button color
     * @param hover color used when the mouse is over the button
     */
    ...
    /**
     * Builds the shared CSS used by graph editing buttons.
     *
