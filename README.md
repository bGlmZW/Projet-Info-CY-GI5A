...
Application JavaFX permettant de visualiser le déplacement d'ambulances dans un graphe pondéré. Les ambulances se déplacent de nœud en nœud en suivant un chemin calculé par un algorithme de plus court chemin (Dijkstra ou A*).
